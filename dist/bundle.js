...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.scss */ \"./src/styles.scss\");\n/* harmony import */ var _modules_renderTasks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/renderTasks */ \"./src/modules/renderTasks.js\");\n/* harmony import */ var _modules_dragDrop__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/dragDrop */ \"./src/modules/dragDrop.js\");\n/* harmony import */ var _modules_checkStatus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/checkStatus */ \"./src/modules/checkStatus.js\");\n/* harmony import */ var _modules_addtask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/addtask */ \"./src/modules/addtask.js\");\n/* harmony import */ var _modules_remove__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/remove */ \"./src/modules/remove.js\");\n\n\n\n\n\n\n\n\nlet toDoTasks = [\n  {\n    description: 'Go to the gym',\n    completed: false,\n    index: 0,\n  },\n  {\n    description: 'Visit Dubai',\n    completed: true,\n    index: 1,\n  },\n  {\n    description: 'Watch the sunset',\n    completed: false,\n    index: 2,\n  },\n];\n\nconst displayTasks = () => {\n  _modules_renderTasks__WEBPACK_IMPORTED_MODULE_1__.listContainer.innerHTML = '';\n  toDoTasks.forEach((task) => (0,_modules_renderTasks__WEBPACK_IMPORTED_MODULE_1__.createItemTask)(task));\n};\n\nconst refrestCompletedTask = (bool, element) => {\n  if (bool) {\n    toDoTasks[parseInt(element.dataset.id, 10)].completed = true;\n    element.setAttribute('checked', 'true');\n  } else {\n    toDoTasks[parseInt(element.dataset.id, 10)].completed = false;\n    element.removeAttribute('checked');\n  }\n};\n\nconst getTaskData = () => {\n  if (localStorage.getItem('TaskData') != null) {\n    toDoTasks = JSON.parse(localStorage.getItem('TaskData'));\n  }\n};\n\nconst setData = () => {\n  localStorage.setItem('TaskData', JSON.stringify(toDoTasks));\n};\n\nconst refrestTargetDragDrop = () => {\n  const tasks = document.querySelectorAll('.container-list .item');\n\n  tasks.forEach((task) => {\n    task.addEventListener('dragstart', _modules_dragDrop__WEBPACK_IMPORTED_MODULE_2__.dragStart);\n    task.addEventListener('dragend', _modules_dragDrop__WEBPACK_IMPORTED_MODULE_2__.dragEnd);\n    task.addEventListener('dragover', _modules_dragDrop__WEBPACK_IMPORTED_MODULE_2__.dragOver);\n    task.addEventListener('drop', (e) => {\n      (0,_modules_dragDrop__WEBPACK_IMPORTED_MODULE_2__.dragDrop)(e);\n      const items = [..._modules_renderTasks__WEBPACK_IMPORTED_MODULE_1__.listContainer.children];\n\n      toDoTasks = [];\n\n      items.forEach((item, index) => {\n        const newTask = new _modules_addtask__WEBPACK_IMPORTED_MODULE_4__.Task(item.children[1].textContent, item.children[0].checked, index);\n        toDoTasks.push(newTask);\n        setData();\n      });\n    });\n  });\n};\n\nconst checkBoxStatusContentLoad = () => {\n  const items = [..._modules_renderTasks__WEBPACK_IMPORTED_MODULE_1__.listContainer.children];\n\n  items.forEach((item) => {\n    (0,_modules_checkStatus__WEBPACK_IMPORTED_MODULE_3__.changeStyleTask)(item.children[0].checked, item.children[0]);\n  });\n};\n\nconst refreshEditableItems = (tasks) => {\n  const editableItems = document.querySelectorAll('.container-list li .text-task');\n\n  editableItems.forEach((item) => {\n    item.addEventListener('input', () => {\n      tasks[parseInt(item.dataset.id, 10)].description = item.textContent;\n      setData();\n    });\n  });\n};\n\ndocument.addEventListener('DOMContentLoaded', () => {\n  getTaskData();\n  setData();\n  displayTasks();\n  checkBoxStatusContentLoad();\n  refrestTargetDragDrop();\n  refreshEditableItems(toDoTasks);\n});\n\n_modules_renderTasks__WEBPACK_IMPORTED_MODULE_1__.listContainer.addEventListener('click', (e) => {\n  if (e.target.classList.contains('checkbox')) {\n    (0,_modules_checkStatus__WEBPACK_IMPORTED_MODULE_3__.checkBoxStatus)(e.target);\n    refrestCompletedTask(e.target.checked, e.target);\n    setData();\n  }\n\n  if (e.target.classList.contains('remove')) {\n    e.target.parentElement.remove();\n    (0,_modules_remove__WEBPACK_IMPORTED_MODULE_5__.removeSelectedItem)(toDoTasks, e.target.dataset.id);\n    setData();\n    displayTasks();\n    refrestTargetDragDrop();\n    refreshEditableItems(toDoTasks);\n  }\n});\n\n_modules_remove__WEBPACK_IMPORTED_MODULE_5__.removeAllIcon.addEventListener('click', () => {\n  toDoTasks = (0,_modules_remove__WEBPACK_IMPORTED_MODULE_5__.removeAllItems)(toDoTasks, _modules_renderTasks__WEBPACK_IMPORTED_MODULE_1__.listContainer);\n  setData();\n});\n\n_modules_addtask__WEBPACK_IMPORTED_MODULE_4__.inputTask.addEventListener('keyup', (e) => {\n  e.preventDefault();\n  if (e.keyCode === 13) {\n    const input = document.querySelector('.input-task');\n    (0,_modules_addtask__WEBPACK_IMPORTED_MODULE_4__.addTask)(toDoTasks, input);\n    setData();\n    displayTasks();\n    refrestTargetDragDrop();\n    refreshEditableItems(toDoTasks);\n    input.value = '';\n  }\n});\n\n_modules_remove__WEBPACK_IMPORTED_MODULE_5__.clearCompletedTasks.addEventListener('click', () => {\n  if (toDoTasks.length > 0) {\n    toDoTasks = (0,_modules_remove__WEBPACK_IMPORTED_MODULE_5__.removeCompletedItem)(toDoTasks);\n    toDoTasks.forEach((task, index) => {\n      task.index = index;\n    });\n    setData();\n    displayTasks();\n    refrestTargetDragDrop();\n    refreshEditableItems(toDoTasks);\n  }\n});\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
